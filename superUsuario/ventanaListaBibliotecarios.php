              ...
              <form name="frm" class="form-horizontal">
                <div class="form-group">
                  <div class="table-responsive col-sm-12">                    
                    <table class="table table-hover" id="idTablaVentanaListaBibliotecarios">
                    </table>
                  </div>
                </div>
              </form>
...
<div class="footer-fix"></div>    
  ...
  <script src="evento/eventosVentanaListaBibliotecario.js"></script>    
