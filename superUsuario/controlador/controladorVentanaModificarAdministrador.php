<?php
  ...
  if (strcmp($accionElegida, "mostrarInformacionTablaAdministrador") == 0) {
    mostrarTodaInformacionTablaAdministradorParaModificar();    
      ...
      $sentencia = "UPDATE administrador SET nombre = '$nombre', apellido = '$apellido', contrasena = '$contrasena', genero = '$genero', correo = '$correo', estado = '$estado' WHERE idUsuario = '$idUsuario'";
      modificar($sentencia);
  }
