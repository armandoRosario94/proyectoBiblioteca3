        ...
        <div class="col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <center>Modificar Carrera</center>
            </div>
            <div class="panel-body">
              <form action="php/guardarDatos.php" method="post" name="frm" class="form-horizontal">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select class="form-control" name="selectCampus" id="selectCampusModificar">

                    </select>
                  </div>
                </div>
                <label>Selecciona la carrera que desea modificar:</label><p>
                <div class="form-group">
