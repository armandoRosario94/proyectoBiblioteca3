...
<html lang="es">
  ...
  <body class="no-skin"><!--xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxcomienza el bodyxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx-->
    ...
    <section id="idEspacioSection">
        ...
        <div class="col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-2">
          <div class="panel panel-primary">
            <div class="panel-heading" id="idCambioColorPanel">
              <center>Modificar Administrador</center>
            </div>
            <div class="panel-body">
              <form action="#" method="post" name="frm" class="form-horizontal">
                <label>Selecciona el administrador que desea Modificar:</label><p>
                <div class="form-group">
                  <div class="table-responsive col-sm-12">
                    <table class="table table-hover" id="idTablaInformacionAdministradorModificar">
                ...
                <div class="form-group">
                  <center>
                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#idModalModificarAdministrador" data-whatever="@mdo" id="idbotonModificar">
      ...
      <div class="modal fade" id="idModalModificarAdministrador" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
              </button>
              <h4 class="modal-title" id="exampleModalLabel">Modificar Administrador</h4>
            </div>
            <div class="modal-body">
              <div class="row">
                <form id = "formularioModalModificarAdministrador">
                  <div class="form-group">
                    <label for="" style="text-align:left" class="col-sm-4 control-label">Id Usuario:</label>
                    <div class="col-sm-8">                    
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-primary" id="botonModalModificarAdministrador" form="formularioModalModificarAdministrador">Guardar Cambios</button>
            </div>
          </div>
        </div>
      </div>
  ...
  <script src="evento/eventosVentanaModificarAdministrador.js"></script>    
