...
<html lang="es">
  ...
  <body class="no-skin"><!--xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxcomienza el bodyxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx-->
    ...
    <section id="idEspacioSection">
        ...
        <div class="col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-2">
          <div class="panel panel-primary">
            <div class="panel-heading" id="idCambioColorPanel">
              <center>Eliminar Administrador</center>
            </div>
            <div class="panel-body">
              <form action="#" method="post" name="frm" class="form-horizontal">
                <label>Selecciona el administrador que desea eliminar:</label><p>
                <div class="form-group">
                  <div class="table-responsive col-sm-12">
                    <table class="table table-hover" id="idTablaInformacionAdministradorEliminar">
                ...
                <div class="form-group">
                  <center>
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#idModalEliminarAdministrador" data-whatever="@mdo" id="idbotonEliminar">
      ...
      <div class="modal fade" id="idModalEliminarAdministrador" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="exampleModalLabel">Eliminar Administrador</h4>
            </div>
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary" id="idBotonModalEliminarAdministrador">Eliminar</button>
            </div>
          </div>
        </div>
      </div>
  ...
  <script src="evento/eventosVentanaEliminarAdministrador.js"></script>    
